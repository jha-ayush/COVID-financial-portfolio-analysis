...
def get_ticker_data_df(data, ticker_symbol):
    idx = pd.IndexSlice
    daily_returns_df = data.loc[idx[:,ticker_symbol],['daily_returns']]
...
if __name__ == "__main__":
    ...
    data_df = get_prices(start_date,end_date,ticker_list)

    
    ticker_df_list = []
    for tk in ticker_list:
        ticker_df_list.append(get_ticker_data_df(data_df,tk))
